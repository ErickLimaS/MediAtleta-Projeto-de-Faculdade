...
public class Calculos {
    ...
    DecimalFormat df = new DecimalFormat("0.00");               // LIMITA A 2 DECIMAIS A VARIAVEL MEDIA
    ...
    public String atacante(float ritmo, float drible, float finalizacao, float defesa, float passe, float cobrPenalti, float cobrFalta) { 
        ...
        media = String.valueOf(df.format((ritmo + drible + finalizacao + defesa + passe + cobrPenalti + cobrFalta) /7));
