...
public class LateralDirEsq extends javax.swing.JFrame {

    /**
     * Creates new form LateralDirEsq
     */
    public LateralDirEsq() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LateralDirEsq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LateralDirEsq().setVisible(true);
            }
        });
    }
